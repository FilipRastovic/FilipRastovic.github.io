    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-md-4 col-md-offset-1 col-sm-8 col-sm-offset-2">
        ...
        <form action="https://stargazerstudio.us17.list-manage.com/subscribe/post?u=efb61a9e2a6a0b8523d778d7c&amp;id=fc04893671"
          method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="form validate" target="_blank"
          novalidate>
          ...
          <input type="email" value="" name="EMAIL" placeholder="Email" class="required form-control email" id="mce-EMAIL"
            data-toggle="tooltip-1" data-placement="top" title="Full Name">
          ...
          <textarea rows="6" type="text" value="" name="MMERGE3" class="form-control" id="mce-MMERGE3" placeholder="Leave your message here"
            data-toggle="tooltip-4" data-placement="top" title="Your Message"></textarea>
